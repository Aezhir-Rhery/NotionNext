...
const TagItemMini = ({ tag, selected = false }) => {
  return (
    <Link
      ...
      passHref
      className={`cursor-pointer inline-block rounded hover:bg-gray-500 hover:text-white
        ...
        : `text-gray-600 dark:border-gray-400 notion-${tag.color}_background dark:bg-gray-800`}` }>
